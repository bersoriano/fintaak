      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 
              className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-[--charcoal] mb-6"
          ...
          <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-8 sm:p-12 mb-12 shadow-lg">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
              ...
              <div className="bg-white rounded-lg px-6 py-4 shadow-md min-w-[140px] text-center">
                ...
                <div className="text-xl font-bold text-[--charcoal]" style={{ fontFamily: 'var(--font-poppins)' }}>
                  $300
                </div>
              </div>

              {/* Arrow/Plus */}
              <div className="text-[--trust-blue] transform rotate-90 sm:rotate-0">
              ...
              <div className="bg-white rounded-lg px-6 py-4 shadow-md min-w-[140px] text-center">
                ...
                <div className="text-xl font-bold text-[--trust-blue]" style={{ fontFamily: 'var(--font-poppins)' }}>
                  $2.99
                </div>
              </div>

              {/* Plus */}
              <div className="text-[--charcoal] text-2xl font-bold">+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[--trust-blue] bg-opacity-10 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <h3 className="font-semibold text-[--charcoal] mb-2" style={{ fontFamily: 'var(--font-poppins)' }}>
                Sin Sorpresas
              </h3>
